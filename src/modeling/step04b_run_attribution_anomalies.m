%% step04b_run_attribution_anomalies.m - Twin Random Forest Machine Learning Driver Attribution (Anomalies)
% =========================================================================
...
%   2. Convert all input driver variables (P, ET, Q, GW_abs, SW_abs) to ANOMALIES 
%      by subtracting their respective temporal means.
%   3. Train Twin Random Forest Models per basin in parallel (parfor):
...
%
% OUTPUT:
%   - outputs/tables/attribution_results_anomalies.mat containing:
%     R2_nat, R2_anthro, Delta_R2, feature_importance, TWSC_obs, TWSC_pred_nat, TWSC_pred_anthro
% =========================================================================

fprintf('=== STEP 4b: Starting Twin RF Machine Learning Attribution (Anomalies) ===\n');
...
attr_file = fullfile(output_dir, 'attribution_results_anomalies.mat');
